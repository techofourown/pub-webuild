  ...
  plugins: [
    {
      rules: {
        ...
        'no-external-attribution': (parsed, when = 'always') => {
          ...
          const ATTRIBUTION_PATTERNS = /Co-Authored-By|Co-authored-by|Generated with|generated by|Assisted by|Thanks to|With help from|👥|🤖|Created by|Authored by|Written by|Produced by|Made with|Attribution:|Credits:|Acknowledgment:/i;
